...
Pod::Spec.new do |s|
  s.name             = 'trezor-firmware-crypto-ios'
  s.version          = '0.1.0'
  s.summary          = 'A short description of trezor-firmware-crypto-ios.'
...
TODO: Add long description of the pod here.
  ...
  s.source_files = 'trezor-firmware-crypto-ios/Classes/**/*'
  
  # s.resource_bundles = {
  #   'trezor-firmware-crypto-ios' => ['trezor-firmware-crypto-ios/Assets/*.png']
  # }
